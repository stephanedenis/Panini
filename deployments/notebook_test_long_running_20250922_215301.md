# 📓 Déploiement Notebook: test_long_running

## 🚀 Notebook Créé
- **Nom**: test_long_running
- **Template**: Analyse dhātu GPU
- **Timestamp**: 2025-09-22T21:53:01.171792

## 🔗 Accès Direct
- **Colab**: [test_long_running.ipynb](https://colab.research.google.com/github/stephanedenis/PaniniFS-Research/blob/main/colab_integration/notebooks/test_long_running.ipynb)
- **Local**: `notebooks/test_long_running.ipynb`
- **Colab Dir**: `colab_integration/notebooks/test_long_running.ipynb`
