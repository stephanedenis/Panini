# 📓 Déploiement Notebook: github_only_demo

## 🚀 Notebook Créé
- **Nom**: github_only_demo
- **Template**: Analyse dhātu GPU
- **Timestamp**: 2025-09-22T22:03:25.210044

## 🔗 Accès Direct
- **Colab**: [github_only_demo.ipynb](https://colab.research.google.com/github/stephanedenis/PaniniFS-Research/blob/main/colab_integration/notebooks/github_only_demo.ipynb)
- **Local**: `notebooks/github_only_demo.ipynb`
- **Colab Dir**: `colab_integration/notebooks/github_only_demo.ipynb`
