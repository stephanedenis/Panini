...
def test_colab_client_import():
    ...
    from panini_engine import ColabClient
...
def test_registry_writer_import():
    ...
    from panini_engine import RegistryWriter
