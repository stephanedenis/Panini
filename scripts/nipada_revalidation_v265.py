#!/usr/bin/env python3
"""
§265 — Revalidation après densification prophétique (graphe v17p).

Charge :
  - signed_corpus_v263_clean.json    (100 textes, base §263 dédupl.)
  - signed_corpus_v264_prophetic.json (16 textes prophétiques §264)
  - nipada_v265_graph_v17p.json      (graphe densifié §265)

Calcule :
  - R² sur v263_clean seul (100 textes, graphe v17p) — baseline propre
  - R² sur v264_prophetic seul (16 textes)
  - R² sur merged (116 textes, 1056+ paires)
  - Permutation test (1000 shuffles) sur merged

Sortie :
  nipada/falsification/nipada_v265_revalidation.json

Usage :
  python3 nipada_revalidation_v265.py [--perms N]
"""
...
GRAPH_PATH   = FALSI_DIR / "nipada_v265_graph_v17p.json"
...
OUT_PATH     = FALSI_DIR / "nipada_v265_revalidation.json"
...
def main() -> None:
    ...
    print("=" * 65)
    print("§265 — Revalidation densification prophétique (v17p)")
    print("=" * 65)
    ...
    # ── Évaluation R² ────────────────────────────────────────────────────────
    print("\nCalcul R² corpus v263_clean (100 textes, graphe v17p)...")
    t1 = time.time()
    ...
    print(f"\n── Résultats §265 ────────────────────────────────────────────────")
    print(f"  R² v263_clean (100 textes, v17p) = {m263['r2']:.4f}")
