# Index des journaux de bord — NIPADA

> Journaux de session du projet NIPADA, classés chronologiquement.
> Un fichier par jour de travail intensif.
...
| [2026-04-25](2026-04-25.md) | §94-§102 | 1201 | Suite §94→§100 + pivot encyclopédique §101, V7 §102 |
| [2026-04-26](2026-04-26.md) | §135-§137 | 2501 | Parser LaTeX réel, propagateur cross-modal V14, auto-digestion |
| [2026-04-27](2026-04-27.md) | §181-§194 | 819 | Sprint §181-§194 suite |
| [2026-04-29](2026-04-29.md) | §206c-§206f | 305 | Densification corpus, sprint late_antique + canal orientaliste |
...
Chaque journal suit la structure :
...
## Plan journée complète — ~N étapes
(Plan numéroté par blocs §)
...
- Un fichier par jour calendaire (même si plusieurs sessions)
- Nom : `YYYY-MM-DD.md`
- Sections référencées : `§NNN` (numéro de section du roadmap)
